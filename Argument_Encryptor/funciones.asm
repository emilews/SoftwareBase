...
;recibe apuntador a ASCII en eax
...
;recibe en ebx: la dirección con el nombre del file
;recibe en esi: la dirección del buffer de lectura
...
;--------------------------------------------------------------------
;--------------------------------------------------------------------
;Works with eax (which is the text to encryp) and edx (the key)
encrypt:
    push ecx                ;Saving ecx
    push ebx                ;Saving ebx
    push esp                ;Saving esp
...
;Same as with the encrypt function
decrypt:
    push ecx                ;Saving ecx
    push ebx                ;Saving ebx
    mov ecx, 0              ;Initialise ecx
